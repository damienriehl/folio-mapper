...
async def test_orchestrator(llm_config):
    ...
    with (
        ...
        patch("app.services.pipeline.orchestrator._build_folio_candidate_from_judged", side_effect=lambda j, sl: FolioCandidate(
            ...
            branch="Service", branch_color="#138D75", hierarchy_path=["Service"], score=j.adjusted_score,
                    ...
                    BranchGroup(
                        ...
                        candidates=[
                            FolioCandidate(
                                ...
                                branch="Service",
                                branch_color="#138D75",
                                hierarchy_path=["Service", "Investigation"],
                                score=95.0,
                            ),
                        ],
                    ),
...
async def test_acceptance_agency_investigation(llm_config):
    ...
    mock_search_candidates = [
        FolioCandidate(
            ...
            hierarchy_path=["Service", "Investigation"], score=85.0,
        ),
        FolioCandidate(
            ...
            hierarchy_path=["Service", "Enforcement"], score=80.0,
        ),
        FolioCandidate(
            ...
            hierarchy_path=["Actor / Player", "Agency"], score=70.0,
        ),
    ]
